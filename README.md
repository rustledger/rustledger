...
[![Crates.io](https://img.shields.io/crates/v/rustledger-core.svg)](https://crates.io/crates/rustledger-core)
[![Documentation](https://docs.rs/rustledger-core/badge.svg)](https://docs.rs/rustledger-core)
[![License](https://img.shields.io/crates/l/rustledger-core.svg)](LICENSE)
...
cargo install rustledger-cli

# Install only rledger-* commands (no bean-* aliases)
cargo install rustledger-cli --no-default-features
```
...
| [`rustledger-cli`](crates/rustledger-cli) | Command-line tools |
