...
mod tests {
    ...
    fn test_process_pads_basic() {
        ...
        assert_eq!(txn.postings[0].amount(), Some(&Amount::new(dec!(1000.00), "USD")));
    ...
    fn test_process_pads_with_existing_balance() {
        ...
        assert_eq!(txn.postings[0].amount(), Some(&Amount::new(dec!(500.00), "USD")));
    }
    ...
    fn test_process_pads_unused_pad() {
        ...
        assert!(result.errors[0].message.contains("no corresponding balance"));
    }
