...
"#;
    ...
    assert!(
        rs_success,
        "Rust should handle pad directive: {rs_output}"
    );
...
"#;
    ...
    assert!(
        rs_success,
        "Rust should handle pushtag/poptag: {rs_output}"
    );
...
"#;
    ...
    assert!(
        py_success,
        "Python should handle metadata: {py_output}"
    );
    assert!(
        rs_success,
        "Rust should handle metadata: {rs_output}"
    );
...
"#;
    ...
    assert!(
        py_success,
        "Python should handle cost/price: {py_output}"
    );
    assert!(
        rs_success,
        "Rust should handle cost/price: {rs_output}"
    );
...
"#;
    ...
    assert!(
        py_success,
        "Python should handle event/query: {py_output}"
    );
    assert!(
        rs_success,
        "Rust should handle event/query: {rs_output}"
    );
...
"#;
    ...
    assert!(
        rs_success,
        "Rust should handle note directive: {rs_output}"
    );
