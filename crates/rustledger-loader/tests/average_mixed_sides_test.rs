...
/// A sale from the long side beside a short realizes the long pool's gain:
/// 2 sold at 110 against a basis of 102 is 16. Pooling the short in priced it
/// at 102.67 and realized 15.
#[test]
fn a_sale_beside_a_short_realizes_the_long_pools_gain() {
    let mut f = tempfile::Builder::new()
        .prefix("average-mixed-")
        .suffix(".beancount")
        .tempfile()
...
"#,
    ...
    assert_eq!(g.proceeds.number, Decimal::from(220));
}
