...
## [0.9.2](https://github.com/rustledger/rustledger/compare/v0.9.1...v0.9.2) - 2026-02-25

### Bug Fixes

- *(cargo)* use local README.md for sub-crates

### Documentation

- update PERFORMANCE_ROADMAP to reflect Logos+Winnow migration
- update parser documentation to reflect Winnow migration
