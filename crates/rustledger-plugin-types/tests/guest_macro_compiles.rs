...
//! fails to compile.
//!
//! Each `#[test]` is a thin wrapper around an `#[allow(dead_code)]`
//! macro invocation: cargo test verifies they all compile.
//! The macro-generated `extern "C"` exports never get called from
//! this binary — they're just here to prove the expansion is valid.
//!
