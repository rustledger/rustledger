# Import System — Architecture & Design

> The forward-looking import roadmap now lives at
> [docs/roadmap/importing.md](../roadmap/importing.md). This document retains
> the detailed architecture and design (importer pipeline, source archive,
> compliance, categorization) for reference. Some sections describe
