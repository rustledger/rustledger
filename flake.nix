{
  description = "beancount-rs - A pure Rust implementation of Beancount";
    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem = { config, self', inputs', pkgs, system, lib, ... }:
        let
          ...
          # Build the crate
          beancount-rs = craneLib.buildPackage (commonArgs // {
        ...
        in
        {
          ...
          # Packages
          packages = {
            default = beancount-rs;
            beancount-rs = beancount-rs;
            ...
            wasm = craneLib.buildPackage (commonArgs // {
              inherit cargoArtifacts;
              cargoExtraArgs = "--target wasm32-unknown-unknown -p beancount-wasm";
          ...
          devShells.default = craneLib.devShell {
            ...
            shellHook = ''
              ...
              echo "🦀 beancount-rs development environment"
              echo ""
